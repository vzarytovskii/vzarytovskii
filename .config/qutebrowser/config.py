...
c.colors.tabs.pinned.selected.even.fg = "#cccccc"
c.colors.tabs.pinned.selected.odd.bg = "black"
c.colors.tabs.pinned.selected.odd.fg = "#cccccc"
...
c.fonts.tabs.selected = '8pt JetBrains Mono'
c.fonts.tabs.unselected = '8pt JetBrains Mono'
